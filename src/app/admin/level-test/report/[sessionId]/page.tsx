...
const LEVEL_DESCRIPTIONS: Record<string, string> = {
  ...
  'Lv7_High2': '고등학교 2학년 수준의 심화 지문을 분석하고 이해할 수 있습니다.',
  'Lv8_High3': '고등학교 3학년 수준으로 수능 대비가 가능한 높은 독해력을 갖추고 있습니다.',
};
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={areaData} layout="vertical" margin={{ top: 5, right: 50, bottom: 5, left: 0 }}>
                    ...
                    <Bar dataKey="rate" radius={[0, 6, 6, 0]} barSize={28}>
                      ...
                      <LabelList dataKey="rate" position="right" formatter={(value) => `${value}%`} style={{ fontSize: 13, fontWeight: 600, fill: '#374151' }} />
                    </Bar>
                  </BarChart>
                </ResponsiveContainer>
              </div>
